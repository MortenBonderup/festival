...
export default function StagePage() {
    ...
    const stageevents = [
        ...
        { stageid: "2", eventtext: "Billie Elish", uid: "5", category: "Pop" },
    ...
    return (
        <div>
            Search by artist:
            <input type="text" id="search" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} placeholder="Search for artist" />
